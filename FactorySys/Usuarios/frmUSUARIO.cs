...
namespace FactorySys.Usuarios
{
    public partial class frmUSUARIO : Form
    {
        ...
        private void btnACEPTAR_Click(object sender, EventArgs e)
        {
            ...
            if (cFacada.ValidacionEMAIL(txtEMAIL.Text) == false)
            {
            ...
            oUsuario.CONTRASEÑA = cFacada.Encriptar(txtUSUARIO.Text);  
        ...
        private void btnCLAVE_Click(object sender, EventArgs e)
        {
            ...
            {
                oUsuario.CONTRASEÑA = cFacada.Encriptar(oUsuario.USUARIO); 
                oUsuario.PRIMERA = true;
                cFacada.MODIFICAR_USUARIO(oUsuario);
