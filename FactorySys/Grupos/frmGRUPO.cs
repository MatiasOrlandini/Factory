    ...
    public partial class frmGRUPO : Form
    {
        ...
        private void btnGUARDAR_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 1; i <= 4; i++)
            {
                ...
                switch (i) //Cada interacion "i", esta referenciada con una accion (alta baja modificacion consulta)
                {
                    case 1:
                        chk = chklALTA;
        ...
        {
            if (chkALTA.Checked == true)
            {
                for (int i = 0; i < chklALTA.Items.Count; i++)
                {
                    chklALTA.SetItemChecked(i, true);
                }
            }
            else
            {
                for (int i = 0; i < chklALTA.Items.Count; i++)
                {
                    chklALTA.SetItemChecked(i, false);
                }
            }
        ...
        private void chkBAJA_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                for (int i = 0; i < chklBAJA.Items.Count; i++)
                {
                    chklBAJA.SetItemChecked(i, true);
                }
            }
            else
            {
                for (int i = 0; i < chklBAJA.Items.Count; i++)
                {
                    chklBAJA.SetItemChecked(i, false);
                }
            }
        }
        ...
        private void chkMODIFICAR_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                for (int i = 0; i < chklMODIFICACION.Items.Count; i++)
                {
                    chklMODIFICACION.SetItemChecked(i, true);
                }
            }
            else
            {
                for (int i = 0; i < chklMODIFICACION.Items.Count; i++)
                {
                    chklMODIFICACION.SetItemChecked(i, false);
                }
            }
        }
        ...
        private void chkCONSULTA_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                for (int i = 0; i < chklCONSULTA.Items.Count; i++)
                {
                    chklCONSULTA.SetItemChecked(i, true);
                }
            }
            else
            {
                for (int i = 0; i < chklCONSULTA.Items.Count; i++)
                {
                    chklCONSULTA.SetItemChecked(i, false);
                }
            }
        }
    }
