...
namespace FactorySys
{
    public partial class frmORDENES : Form
    {
        ...
        private void btnELIMINAR_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("No es posible eliminar una Orden de compra con estado 'Entregado'.", "Adventencia", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            if (oOrden.VERIFICADO == true)
            {
                MessageBox.Show("No es posible eliminar una Orden de compra verificada.", "Adventencia", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        private void btnVERIFICAR_Click(object sender, EventArgs e)
        {
            ...
            frmORDEN abrir = new frmORDEN(cOrden.BUSCAR_OC(Convert.ToInt32(dgvORDENES.CurrentRow.Cells[0].Value)), "V");
            DialogResult resultado = abrir.ShowDialog();
            if (resultado == DialogResult.OK)
            {
                ARMAR_GRILLA();
