...
namespace Controladora
{
    public class Pedidos
    {
        ...
        {
            var pedidos = from pedido in oFabrica.PEDIDOS.Include(a => a.CLIENTE.LOCALIDAD).Include(b => b.LINEA_PEDIDO.Select(c=>c.PRODUCTO)).Include("Tareas").ToList()                          
                          select new
                          {
